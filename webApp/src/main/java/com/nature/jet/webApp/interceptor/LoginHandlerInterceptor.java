package com.nature.jet.webApp.interceptor;
...
public class LoginHandlerInterceptor implements HandlerInterceptor
{
            ...
            throws Exception
    {
        ...
        if(requestURI.equals("/web/") || requestURI.equals("/web/login") || requestURI.equals("/web/loginOut"))
        {
            return true;
        }

        Admin userInfo = (Admin) httpServletRequest.getSession().getAttribute(Fields.SESSION_LOGIN_USER);
        if(userInfo != null)
        {
            return true;
        }
